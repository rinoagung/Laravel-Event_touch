...
<div class="d-flex align-items-center alert alert-success alert-dismissible fade show p-2" role="alert">
    ...
    <div class="col-md-5">
        <main class="form-signin">
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit">Sign in</button>
                ...
                <small class="d-block mt-3 text-end"><a href="/register" class="text-decoration-none"><i class="bi bi-pencil-square"></i> Create an account</a>.</small>
                </main>
      </div>
  </div>
@endsection
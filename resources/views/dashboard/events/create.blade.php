...
<div class="col-lg-8">
    <form method="POST" action="/dashboard/events" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="/dashboard/events" class="text-decoration-none p-1 border-bottom fs-5 d-flex" ><span data-feather="arrow-left" class="align-self-center me-1"></span> Back</a>
